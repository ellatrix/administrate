/* global wp, tinymce */
/* See wpeditimgae plugin. This is slightly modified to work without an iframe. */

tinymce.PluginManager.add( 'wpimage', function( editor ) {
	...
	floatingToolbar.reposition = function() {
		...
		if ( iOS ) {
			...
			if ( spaceTop >= verticalSpaceNeeded ) {
				...
				top = boundary.top - toolbarNodeHeight - margin;
